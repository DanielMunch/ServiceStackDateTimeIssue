...
IF /I "ServiceStackDateTimeIssueV2\ServiceStackDateTimeIssue.sln" NEQ "" (
  call :ExecuteCmd nuget restore "%DEPLOYMENT_SOURCE%\ServiceStackDateTimeIssueV2\ServiceStackDateTimeIssue.sln"
  IF !ERRORLEVEL! NEQ 0 goto error
)
